...
def extract_chips(
    ...
    for frame_number, box_list in bounding_boxes:
        ...
        vectorized_faces = vectorize_chips(
            cropped,
            chip_size,
            images_placeholder,
            phase_train_placeholder,
...
# Process extracted face chips through pretrained Tensorflow model to
# obtain vector represenations
def vectorize_chips(
        chips,
        chip_size,
        images_placeholder,
    ...
    # Adjust colors, prewhiten and resize to chip size appropriate for Facenet
    # model input
    ...
    faces = [
        cv2.resize(
            ...
            (chip_size,
             chip_size),
            interpolation=cv2.INTER_LINEAR) for prew in prewhitened]
