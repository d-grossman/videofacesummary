...
def main(test_file, test_folder, test_type, use_gpu, prob_thresh, nms_thresh):
...
if __name__ == '__main__':
    ...
    print(
        "Test parameters set as: \n \
           ...
           Test Type = {2} \n \
           Use GPU = {3} \n \
           TinyFace Probability Threshold = {4} \n \
           TinyFace NMS Threshold = {5} \n "
            .format(
            args.test_file,
            args.test_images,
            args.test_type,
            ...
            args.prob_thresh,
            args.nms_thresh))
    main(args.test_file, args.test_images, args.test_type, args.use_gpu, args.prob_thresh, args.nms_thresh)
    print("Finished test.")